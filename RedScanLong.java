...
public class RedScanLong extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        DcMotor leftbackTemp = hardwareMap.get(DcMotor.class, "bL");
        DcMotor rightBackTemp = hardwareMap.get(DcMotor.class, "bR");
        ...
        leftbackTemp.setDirection(DcMotor.Direction.FORWARD);
        rightBackTemp.setDirection(DcMotor.Direction.FORWARD);

        leftDrive = leftbackTemp;
        rightDrive = rightBackTemp;
